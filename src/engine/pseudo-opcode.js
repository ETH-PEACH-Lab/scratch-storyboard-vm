const pseudoOpcode = {
    ...
    "data_setvariableto": {
        ...
        "pseudocode": "set variable (NAME) to (VALUE)",
        "regex": "^set variable \\((.+)\\) to \\((.+)\\)$",
        "category": "variables",        
        "blockType": "command",
        "inputs": {     
            "NAME": "string",  // variable name
    ...
    "data_changevariableby": {
        ...
        "pseudocode": "change variable (NAME) by (VALUE)",
        "regex": "^change variable \\((.+)\\) by \\((.+)\\)$",
        "category": "variables",
        "blockType": "command", 
        "inputs": { 
            "NAME": "string",  // variable name
